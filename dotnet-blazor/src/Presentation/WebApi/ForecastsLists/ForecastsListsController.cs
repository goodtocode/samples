...
using Coffee.Core.Application.ForecastLists.Queries.GetAll;
using Coffee.Core.Application.ForecastLists.Queries.GetPaginated;
using Coffee.Presentation.WebApi.Common;

namespace Coffee.Presentation.WebApi.ForecastsLists;
...
public class ForecastsListsController : ApiControllerBase
{
    ...
    public async Task<ActionResult<PaginatedList<ForecastPaginatedDto>>> GetCoffeePaginatedQuery([FromQuery] GetForecastsPaginatedQuery query)
    {
