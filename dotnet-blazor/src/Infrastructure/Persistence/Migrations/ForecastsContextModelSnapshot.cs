...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coffee.Core.Domain.Forecasts.Entities.Forecast", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Coffee.Core.Domain.Forecasts.Entities.WeatherForecastZipcode", b =>
                {
                    b.Property<Guid>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Coffee.Core.Domain.Forecasts.Models.ForecastsView", b =>
                {
                    b.Property<Guid>("Key")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Coffee.Core.Domain.Forecasts.Entities.WeatherForecastZipcode", b =>
                {
                    b.HasOne("Coffee.Core.Domain.Forecasts.Entities.Forecast", "WeatherForecast")
                        .WithMany("ZipCodes")
