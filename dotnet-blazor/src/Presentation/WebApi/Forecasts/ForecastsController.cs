using Coffee.Core.Application.Forecasts.Commands.Add;
using Coffee.Core.Application.Forecasts.Commands.Patch;
using Coffee.Core.Application.Forecasts.Commands.Remove;
using Coffee.Core.Application.Forecasts.Commands.Update;
using Coffee.Core.Application.Forecasts.Queries.Get;
using Coffee.Presentation.WebApi.Common;

namespace Coffee.Presentation.WebApi.Forecasts;
